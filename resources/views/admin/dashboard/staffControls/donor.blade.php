...
$(document).ready(function(){
    ...
    $(document).on('click', '#btnView',function(e){
        ...
        var url = '{{ url("admin/dashboard/fetchSingleDonor/:id") }}';
    ...
    function fetchDonor()
    {
        var url = '{{ url("admin/dashboard/fetchDonor") }}';
    ...
    {
        var url = '{{ url("admin/dashboard/fetchActiveDonor") }}';
    ...
    {
        var url = '{{ url("admin/dashboard/fetchInactiveDonor") }}';
    ...
    function searchDonor()
    {
        ...
        var url = '{{ url("admin/dashboard/searchDonor/:input") }}';
    ...
    $(document).on('click', '#btnChangeStatusActive',function(e){
        ...
        var url = '{{ url("admin/dashboard/changeDonorStatus/:id") }}';
