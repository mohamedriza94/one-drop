                ...
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <button class="btn btn-primary form-control btn-lg" type="submit" id="btnSaveTags">Save</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="modal-body bg-light">
                ...
                <form method="POST" id="addPhotosCampaign" enctype="multipart/form-data">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <label class="form-label" style="opacity:0;">.</label>
                            <button class="btn btn-danger form-control btn-lg" type="submit" id="btnSaveTags">Upload</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    $.each(response.campaigns,function(key,item){
                        ...
                        <button value="'+item.no+'" class="btn btn-danger btn-sm" id="btnDeleteCampaign"><i class="fa fa-trash"></i></button>';
