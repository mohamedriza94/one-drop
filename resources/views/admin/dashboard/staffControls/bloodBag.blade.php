...
<script>
    $(document).ready(function(){
        ...
        //change button colors start
            ...
            var bloodGroup = 'A+';
            customURL = '{{ url("admin/dashboard/fetchCustomBloodBags/:bloodGroup") }}';
        ...
        function chooseFilter()
        {
            ...
            if(combo.selectedIndex == 4)
            {
                ...
                publicURL = '{{ url("admin/dashboard/fetchUsedBloodBags") }}';
            }
            else if(combo.selectedIndex == 3)
            { 
                unClickCustomButtons();
                publicURL = '{{ url("admin/dashboard/fetchExpiredBloodBags") }}';
            }
            else if(combo.selectedIndex == 2)
            { 
                unClickCustomButtons();
                publicURL = '{{ url("admin/dashboard/fetchAvailableBloodBags") }}';
            }
            else if(combo.selectedIndex == 1)
            {
                unClickCustomButtons();
                publicURL = '{{ url("admin/dashboard/fetchBloodBags") }}';
            }
        ...
        $(document).on('click', '#btnViewBloodDetails',function(e){
            ...
            url = '{{ url("admin/dashboard/fetchSingleBloodBag/:bloodBagNo") }}';
